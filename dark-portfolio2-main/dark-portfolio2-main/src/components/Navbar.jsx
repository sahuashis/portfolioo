    ...
    <div className='bg-gray-950 -mb-7 z-50 w-full py-3 fixed'>
      <div className='flex items-center justify-between max-w-7xl mx-auto px-4 md:px-0'>
        ...
        <div data-aos="fade-down"
          data-aos-offset="500">
          <a className='text-white text-xl font-semibold' href="/">Ashis Sahu</a>
        </div>

        <nav className='hidden lg:block'>
          <ul data-aos="fade-down"
            data-aos-offset="500" className='flex gap-7 text-xl items-center font-semibold text-white'>
        ...
        <div data-aos="fade-down"
          data-aos-offset="500" className='lg:hidden text-white text-4xl lg:text-7xl'>
          {
