            ...
            <div className='flex flex-col justify-center space-y-8'>
                <div>
                    ...
                    <p className='text-gray-600 mt-2'>
                        <a href="#" className='text-blue-500 hover:underline'>sahuashis374@gmail.com</a>
                    </p>
                </div>
                <div>
                    <h3 className='text-2xl font-semibold text-gray-300'>Phone</h3>
                    <p className='text-gray-600 mt-2 flex flex-col'>
                        <a href="#" className='text-blue-500 hover:underline'>7735215292</a>
                        <a href="#" className='text-blue-500 hover:underline'>8018885031</a>
